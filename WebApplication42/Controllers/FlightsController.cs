...
namespace WebApplication42.Controllers
{
    ...
    public class FlightsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FlightID,Airways,FROM,TO,SeatType,Departure_Date,DepartureTime,Return_Flight,Return_Date,Return_Time,NumAdults,NumAChild,Seat_Type_Calc,Airline_Fee,ReturnTicket_Price,passenger_Cost,Add_Flight_Delay,Available_Seats,SEAT")] Flight flight)
        {
            if (ModelState.IsValid)
            {
                ...
                flight.Add_Flight_Delay = flight.Delay();
                flight.Available_Seats = flight.Seat();
